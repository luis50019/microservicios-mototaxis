...
namespace MicroServicio.Reservaciones.Services
{
    public class RabbitMQService : IDisposable
    {
        ...
        public RabbitMQService(IOptions<RabbitMQSettings> settings, ReservationService reservationService)
        {
            ...
            _channel = Task.Run(async () => await _connection.CreateModelAsync()).Result;
        ...
        public async Task PublishAsync(string message)
        {
            ...
            await _channel.BasicPublishAsync(exchange: "", routingKey: "viaje_registrado_queue", basicProperties: null, body: body);
        }
